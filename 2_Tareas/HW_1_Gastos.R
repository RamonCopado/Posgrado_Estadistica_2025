...
#Tiempo (en minutos) para completar la prueba final de MCF 202.0 cuantitativa
...
Cualitativa
##[1]"Nombre de estudiante" "Direccion de casa"
##[3]"Número telefono" "Área principal de estudio"

##[5]"Grado de año universitario" "Calificación general"
Cuantitativa<-c("Fecha de nacimiento", "Edad", "Puntaje en la prueba de mitad de período",
                "Tiempo","Numero de hermanos")
Cuantitativa
##[1]"Fecha de nacimiento"
##[2]"Edad"
##[3]"Puntaje en la prueba de mitad de período"
##[4]"Tiempo"
...
##[1]"Peso corporal" "Temperatura" "Producción de leche"
##[4]"Número de crías" "Altura" "Frame"
##[7]"Tasa de crecimiento"
...
##[1]"Raza" "Colorpelaje"
##[3]"Sexo" "Tipo de alimentación"
##[5]"Tipo de explotación" "Presencia o ausencia de cuernos"
##[7]"Tipo de orejas"
